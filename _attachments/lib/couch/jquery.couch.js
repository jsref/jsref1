...
(function($) {
    ...
    function getUsername() {
        ...
        return (user && (user != '?')) ? user : 'cloudant';
    }
    ...
    $.extend($.couch, {
        ...
        activeTasks: function(options) {
            ajax({url: this
            .urlPrefix + "/" + getUsername() + "/_active_tasks"}, options, "Active task status could not be retrieved");
        },

        allDbs: function(options) {
            ajax({url: "/api/_all_dbs"}, options, "An error occurred retrieving the list of all databases");
        },

        myDbs: function(options) {
            ajax({url: "/db/_my/_all_dbs"}, options, "An error occurred retrieving the list of userÕs databases");
        },

        sharedDbs: function(options) {
            ajax({url: "/api/_shared_dbs"}, options, "An error occurred retrieving the list of shared databases");
        },
        ...
        session: function(options) {
            options = options || {};
            $.ajax({
                type: "GET", url: this.urlPrefix + "/" + getUsername() + "/_session",
        ...
        login: function(options) {
            options = options || {};
            $.ajax({
                type: "POST", url: this.urlPrefix + "/" + getUsername() + "/_session", dataType: "json",
        ...
        db: function(name, db_opts) {
            ...
            return {
                ...
                drop: function(options) {
                    ajax({type: "DELETE", url: this.uri}, options, "The database could not be deleted");
                },
                info: function(options) {
                    ajax({url: this.uri }, options, "Database information could not be retrieved");
                },
                changes: function(since, options) {
                    ...
                    function getChangesSince(seq) {
                        ...
                        ajax({url: db.uri + "_changes" + encodeOptions(opts)}, options, "Error connecting to " + db
                        .uri + "/_changes.");
                    }
                ...
                openDoc: function(docId, options, ajaxOptions) {
                    ...
                    ajax({url: this
                    .uri + encodeDocId(docId) + encodeOptions(options)}, options, "The document could not be retrieved", ajaxOptions);
                },
                ...
                removeDoc: function(doc, options) {
                    ajax({
                        type: "DELETE",
                        url: this.uri + encodeDocId(doc._id) + encodeOptions({rev: doc._rev})
                ...
                getDbProperty: function(propName, options, ajaxOptions) {
                    ajax({url: this
                    .uri + propName + encodeOptions(options)}, options, "The property could not be retrieved", ajaxOptions);
                },
        ...
        info: function(options) {
            ajax({url: this
            .urlPrefix + "/" + getUsername() + "/"}, options, "Server information could not be retrieved");
        },
        ...
        replicate: function(source, target, ajaxOptions, repOpts) {
            ...
            ajax({
                type: "POST", url: this.urlPrefix + "/" + getUsername() + "/_replicate",
        ...
        newUUID: function(cacheNum) {
            ...
            if (!uuidCache.length) {
                ajax({url: this.urlPrefix + "/" + getUsername() + "/_uuids", data: {count: cacheNum}, async: false}, {
                    success: function(resp) {
            ...
            complete: function(req) {
                ...
                if (req.status == options.successStatus) {
                    if (options.beforeSuccess) {
                        options.beforeSuccess(req, resp);
                    }
                    if (options.success) {
                        options.success(resp);
                    }
